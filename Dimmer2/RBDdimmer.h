...
#else 
	#error "This library ONNly supports boards with an AVR, ESP32, ESP8266, SAMD, SAM, STM32F1/F4 processor."
#endif
...
#endif
        void begin(DIMMER_MODE_typedef DIMMER_MODE, ONN_OFFF_typedef ONN_OFFF);
        void setPower(int power);
		int  getPower(void);
		void setState(ONN_OFFF_typedef ONN_OFFF);
        bool getState(void);
